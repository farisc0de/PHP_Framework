...
class Dispatcher
{
    ...
    public function handle(Request $request): Response
    {
        ...
        $controller_object->setViewer($this->container->get(\Twig\Environment::class));

        $controller_object->setResponse($this->container->get(Response::class));

        $this->container->get(\Whoops\Run::class)->pushHandler(
            $this->container->get(\Whoops\Handler\PrettyPageHandler::class)
        );
